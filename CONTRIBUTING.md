# Contributing to RFX-Fuse

Thank you for your interest in contributing to RFX-Fuse! This document provides guidelines and information for contributors.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/RFX-Fuse.git
   cd RFX-Fuse
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/chriskuchar/RFX-Fuse.git
   ```
...
Include:
- RFX-Fuse version (`rfx.__version__`)
- Python version
...
- Open a [GitHub Issue](https://github.com/chriskuchar/RFX-Fuse/issues)
- Tag with `question` label

---

Thank you for contributing to RFX-Fuse!
